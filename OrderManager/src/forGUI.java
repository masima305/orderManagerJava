...
//regis tab
		...
		JLabel customer_Label = new JLabel("고객목록", SwingConstants.CENTER);
		JPanel customer_Panel = new JPanel();
		customer_Panel.add(customer_Label);
		regis_tab.addTab("고객", customer_Panel);
		
		JLabel income_Label = new JLabel("매출", SwingConstants.CENTER);
		JPanel income_Panel = new JPanel();
		income_Panel.add(income_Label);
		regis_tab.addTab("매출", income_Panel);

		JLabel employee_Label = new JLabel("직원", SwingConstants.CENTER);
		JPanel employee_Panel = new JPanel();
		employee_Panel.add(employee_Label);
		regis_tab.addTab("직원", employee_Panel);

		JLabel menu_Label = new JLabel("메뉴", SwingConstants.CENTER);
		JPanel menu_Panel = new JPanel();
		menu_Panel.add(menu_Label);
		regis_tab.addTab("메뉴", menu_Panel);
...
//읽어봐 https://stackoverflow.com/questions/7050972/layout-manager-preferredsize-java		
	}
}
